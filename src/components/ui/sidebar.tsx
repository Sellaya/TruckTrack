...
>(
  (
    ...
    const readCookie = React.useCallback(() => {
      ...
      return cookieValue === 'true' ? true : cookieValue === 'false' ? false : null
    }, [])
    ...
    // Read cookie and sync state after hydration (client-side only)
    React.useEffect(() => {
    ...
    if (collapsible === "none") {
      return (
        <div
          ...
          data-side={side}
        >
          {/* Spacer div to reserve space in flex layout */}
          <div
            className={cn(
